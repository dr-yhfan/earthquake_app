...
* There is a rake task that can be run periodically to get data from the USGS and store the data to the local database.
  - rake usgs:earthquakes:ingest
  - Repeated running of the rake task will populate the database with new and latest data.
